...
if (fs.existsSync('./public')) {
    ...
    // process.env.databaseUri = 'mongodb+srv://dbShift:<password>@cluster0.bjj0e.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
    process.env.databaseUri = 'mongodb+srv://dbShift:!QAZ2wsx@cluster0.bjj0e.mongodb.net/frogyShift?retryWrites=true&w=majority';
    // process.env.databaseUri = 'mongodb+srv://dbShift:!QAZ2wsx@cluster0.bjj0e.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';
